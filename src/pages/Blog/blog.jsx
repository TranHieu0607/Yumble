...
const Blog = () => {
  const posts = [
    { id: 1, title: 'Thực Đơn Eat Clean Giảm Cân - Món Healthy Đơn Giản với Yumble', image: blog2, description: 'Bạn đang tìm kiếm thực đơn eat clean để giảm cân hiệu quả? 🍽️ Những món healthy đơn giản không chỉ giúp duy trì vóc dáng mà còn tăng cường sức khỏe. Cùng Yumble khám phá những gợi ý thực đơn eat clean dễ làm, giàu dinh dưỡng và phù hợp với mọi chế độ ăn! 🌱' },
    { id: 2, title: 'Thực Đơn Eat Clean Giảm Cân - Món Healthy Đơn Giản với Yumble', image: blog2, description: 'Learn about healthy eating with Yumble.' },
