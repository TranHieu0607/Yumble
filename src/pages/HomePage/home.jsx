...
const HomePage = () => {
  ...
  return (
    <div className="relative">
      <div className='relative flex flex-col h-[712px] items-center justify-center bg-cover bg-center  overflow-hidden' style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <div className='flex flex-row  item-center justify-between ' style={{ backgroundColor: '#FCF9F4', padding: '40px' }}>
        <div className='w-1/2 p-10 mt-20'>
          <h1 className='text-5xl font-bold mb-4' style={{ color: '#293E31' }}>Hương Vị Từ Làng Quê</h1>
          <hr style={{ maxWidth: '650px', border: 'none', borderTop: '2px solid #293E31', margin: '20px 0' }} />
          <div style={{ maxWidth: '600px' }}>
            <p className='text-lg mb-10' style={{ color: '#293E31', lineHeight: '2' }}>
      ...
      <div className='flex flex-col items-center mb-10' style={{ backgroundColor: '#DACEC2', padding: '80px' }}>
        <h2 className="text-3xl font-bold mb-8" style={{ color: '#293E31' }}>Đồ ăn Việt Nam</h2>
        <div className='flex justify-between w-full max-w-7xl items-center'>
          <button onClick={prevProduct} className='text-2xl '>❮</button>
          <div className='flex justify-between w-full max-w-7xl'>
            {foods.slice(startIndex, startIndex + 3).map((product) => (
              <div key={product.id} className='relative w-1/3 text-center mx-2 overflow-hidden group'>
                <Link to={`/recipe/${product.id}`}>
                  <img src={product.image} alt={product.name} className='w-full h-[300px] object-cover transition-transform duration-300 transform group-hover:scale-105' />
                  <div className='absolute bottom-0 left-0 right-0 bg-white bg-opacity-80 text-center p-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100'>
                    {product.name}
                  </div>
                </Link>
              </div>
          ...
          <button onClick={nextProduct} className='text-2xl'>❯</button>
        </div>
      </div>
    </div>
  );
