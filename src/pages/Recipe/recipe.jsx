    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">     
          <div className="mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Công Thức Nấu Ăn</h2>
          ...
          <div className="relative max-w-xl mx-auto">
            <input
              ...
              className="w-full border-2 border-gray-200 rounded-full px-6 py-3 text-base focus:outline-none focus:border-red-400 transition-all duration-300 shadow-sm hover:shadow-md pl-12"
            />
        ...
        {currentFoods.length === 0 ? (
          <div className="text-center py-16">
            <div className="text-gray-500 text-xl">Không tìm thấy công thức nào phù hợp</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6 md:gap-8">
            {currentFoods.map((food, index) => (
              <div 
                key={food.id} 
                className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 ease-in-out transform hover:-translate-y-1"
                style={{
              ...
              >
                <div className="relative overflow-hidden rounded-t-xl aspect-[4/3]">
                  ...
                  <button
                    ...
                    className="absolute top-3 right-3 p-2.5 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-white transition-all duration-300 transform hover:scale-110 active:scale-95"
                  >
                    <svg
                      className={`w-5 h-5 ${
                        isFavorite(food.id) 
                ...
                <div className="p-4">
                  <Link to={`/recipe/${food.id}`} className="block group-hover:text-red-500 transition-colors duration-300">
                    <h2 className="text-lg font-bold mb-2 line-clamp-1">
                      {food.name}
                    </h2>
                    <p className="text-gray-600 text-sm line-clamp-2 group-hover:text-gray-900 transition-colors duration-300">
                      {food.description}
                    </p>
                  </Link>
                </div>
